...
const recommended = Array.from({ length: 12 }).map(() => ({
...
class Recommanded extends Component {
  ...
  render() {
    return (
      <div className="recommanded-wrapper">
        <span className="homepage-categories-title">Recommended</span>
        ...
        <div className="homepage-show-more-btn">SHOW MORE</div>
      </div>
    );
  }
}
